...
import { useRandomFortune, useSavedFortune } from "../../api/useFortune";
import { Skeleton } from "@/features/components/skeletons/Skeleton";
import { FortuneCard } from "../primitives/FrotuneCard";
...
export default function FortuneHome() {
  ...
  const saveFortune = useSavedFortune();
  ...
  return (
    <div className="min-h-[calc(100vdh-4rem)] bg-gradient-to-br from-purple-600 via-pink-500 to-red-500 flex items-center justify-center p-4">
